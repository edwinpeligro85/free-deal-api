...
roles
  .grant(UserRole.CUSTOMER)
    ...
    .createOwn(AppResource.ADDRESS, AppResource.ORDER)
    .updateOwn([AppResource.ORDER])
  ...
  .grant(UserRole.MERCHANT)
    ...
    .createOwn([AppResource.COMPANY, AppResource.BRANCH_OFFICE, AppResource.ADDRESS, AppResource.ORDER])
